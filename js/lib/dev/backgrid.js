/*!
  ...
  NOTE: added "backgrid:presort" event trigger to Backgrid.Body.sort and listener 
        in Backgrid.Grid.initialize to allow a callback before sorting
*/
...
var Grid = Backgrid.Grid = Backbone.View.extend({
  ...
  initialize: function (options) {
    ...
    if (options.presort) {
      this.listenTo(this.body, "backgrid:presort", options.presort);
    }
  },
